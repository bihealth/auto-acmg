...
AutoPVS1 is a program for automatical prediction of PVS1 ACMG criterion for given variant.
...
If you want to **use** AutoPVS1, the best place is to start at :ref:`dev_quickstart`.
