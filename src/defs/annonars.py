...
class VariantByAncestryGroupItem(BaseModel):
    ancestryGroup: str
    counts: Counts
    faf95: Optional[float] = None
    faf99: Optional[float] = None
...
class VariantAlleleCount(BaseModel):
    cohort: Optional[str] = None
    byAncestryGroup: List[VariantByAncestryGroupItem]
    bySex: BySex
    raw: Raw
    grpmax: str
    afGrpmax: float
...
class AnnonarsVariantInfo(BaseModel):
    cadd: Optional[Any] = None
    ...
    gnomad_mtdna: Optional[Any] = None
    gnomad_exomes: Optional[Any] = None
    gnomad_genomes: Optional[GnomadGenome] = None
    helixmtdb: Optional[Any] = None
    ucsc_conservation: Optional[Any] = None
