...
class Cadd(BaseModel):
    ...
    cDNApos: Optional[int] = None
    relcDNApos: Optional[float] = None
    CDSpos: Optional[int] = None
    relCDSpos: Optional[float] = None
    protPos: Optional[int] = None
    relProtPos: Optional[float] = None
    ...
    GerpRS: Optional[float] = None
    GerpRSpval: Optional[float] = None
    ...
    MMSp_acceptorIntron: Optional[float] = None
    MMSp_acceptor: Optional[float] = None
    MMSp_exon: Optional[float] = None
    MMSp_donor: Optional[float] = None
    MMSp_donorIntron: Optional[float] = None
